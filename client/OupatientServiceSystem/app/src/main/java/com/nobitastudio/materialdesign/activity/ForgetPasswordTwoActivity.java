...
public class ForgetPasswordTwoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    static final int MESSAGE_TYPE = 1;//0.注册账号 1.找回密码 2.修改密码 3.办理诊疗卡 4.绑定诊疗卡
    ...
    private void init() {
        ...
        //init widget
        toolbar = findViewById(R.id.activity_forgetpasswordtwo_toolbar);
        ...
        getVerificationCodeButton = findViewById(R.id.activity_forgetpasswordtwo_getverificationcode_button);
        nextStepButton = findViewById(R.id.activity_forgetpasswordtwo_nextstep_button);
        pictureVerificationCodeEditText = findViewById(R.id.activity_forgetpasswordtwo_picture_verificationcode_edittext);
        pictureVerificationCodeImageView = findViewById(R.id.activity_forgetpasswordtwo_picture_verificationcode_imageview);
        messageVerificationCodeEditText = findViewById(R.id.activity_forgetpasswordtwo_message_verificationcode_edittext);
        networkCacheCardView = findViewById(R.id.activity_forgetpasswordtwo_network_cache_cardview);
        errorCardView = findViewById(R.id.activity_forgetpasswordtwo_error_cardview);
        sendSuccessCardView = findViewById(R.id.activity_forgetpasswordtwo_send_success_cardview);
        errorTextView = findViewById(R.id.activity_forgetpasswordtwo_error_textview);
    ...
    private void initBaseData() {
        ...
        preferences = getSharedPreferences(currentDay + updatePasswordAccount, MODE_PRIVATE);
    ...
    public void onClick(View v) {
        ...
        int viewId = v.getId();
        if (viewId == R.id.activity_forgetpasswordtwo_getverificationcode_button) {
            String pictureVerificationCodeText = pictureVerificationCodeEditText.getText().toString();
            if (pictureVerificationCodeText == null || pictureVerificationCodeText.isEmpty()) {
                ...
                if (pictureVerificationCodeIsRight) {
                    ...
                    if (sendCounts < 6) {
                        ...
                        String parameter = "&account=" + updatePasswordAccount + "&messageType=" + MESSAGE_TYPE;
        ...
        } else if (viewId == R.id.activity_forgetpasswordtwo_nextstep_button) {
            ...
            if (verificationCode == null || verificationCode.isEmpty()) {
                ...
                String parameter = "&account=" + updatePasswordAccount + "&verificationCode=" + verificationCode;
                HttpUtil.sendOkHttpRequest(requestAction, parameter, new Callback() {
                    @Override
                    public void onFailure(Call call, IOException e) {
