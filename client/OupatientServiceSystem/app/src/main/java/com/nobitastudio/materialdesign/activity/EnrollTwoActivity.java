...
public class EnrollTwoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    static final String PICTURE_VERIFICATION_CODE_INVALID = "验证码错误";
    ...
    static final int MESSAGE_TYPE = 0; //0.注册账号 1.找回密码 2.修改密码 3.办理诊疗卡 4.绑定诊疗卡
    ...
    private void init() {
        ...
        //init widget
        toolbar = findViewById(R.id.activity_enrolltwo_toolbar);
        ...
        getVerificationCodeButton = findViewById(R.id.activity_enrolltwo_getverificationcode_button);
        nextStepButton = findViewById(R.id.activity_enrolltwo_nextstep_button);
        pictureVerificationCodeEditText = findViewById(R.id.activity_enrolltwo_picture_verificationcode_edittext);
        pictureVerificationCodeImageView = findViewById(R.id.activity_enrolltwo_picture_verificationcode_imageview);
        messageVerificationCodeEditText = findViewById(R.id.activity_enrolltwo_message_verificationcode_edittext);
        networkCacheCardView = findViewById(R.id.activity_enrolltwo_network_cache_cardview);
        errorCardView = findViewById(R.id.activity_enrolltwo_error_cardview);
        sendSuccessCardView = findViewById(R.id.activity_enrolltwo_send_success_cardview);
        errorTextView = findViewById(R.id.activity_enrolltwo_error_textview);
    ...
    private void initBaseData() {
        ...
        preferences = getSharedPreferences(currentDay + enrollAccount, MODE_PRIVATE);
    ...
    public void onClick(View v) {
        ...
        int viewId = v.getId();
        if (viewId == R.id.activity_enrolltwo_getverificationcode_button) {
            ...
            if (pictureVerificationCodeText.isEmpty()) {
                ...
                if (pictureVerificationCodeIsRight) {
                    ...
                    if (sendCounts < 6) {
                        ...
                        String parameter = "&account=" + enrollAccount + "&messageType=" + MESSAGE_TYPE;
        ...
        } else if (viewId == R.id.activity_enrolltwo_nextstep_button) {
            ...
            if (verificationCode == null || verificationCode.isEmpty()) {
                ...
                String parameter = "&account=" + enrollAccount + "&verificationCode=" + verificationCode;
                HttpUtil.sendOkHttpRequest(requestAction, parameter, new Callback() {
                    @Override
                    public void onFailure(Call call, IOException e) {
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        ...
                        message = gson.fromJson(response.body().string(), Message.class);
                        if (message.isSuccess()) {
                            Intent intent = new Intent(EnrollTwoActivity.this, EnrollThreeActivity.class);
